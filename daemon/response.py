...
from .utils import build_set_cookie
...
class Response():   
    ...
    def set_cookie(self, name, value, path="/", http_only=True, same_site="Lax"):
        """Attach one Set-Cookie header to this response."""
        cookie = build_set_cookie(name, value, path, http_only, same_site)
    ...
    def build_response_header(self, request):
        ...
        status = "{} {}".format(self.status_code or 200, self.reason or "OK")
        fmt_header = "HTTP/1.1 {}\r\n".format(status)
